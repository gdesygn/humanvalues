...
const ailes = [
  {
    ...
    artworks: [
      { id: "an1", title: "Rio de Janeiro", subject: "Géographie", text: "La Cidade Maravilhosa, sculptée par sa baie et son énergie.", image: "/artworks/geo_1.jpg" },
      { id: "an2", title: "Dakar", subject: "Géographie", text: "La presqu'île vibrante, capitale ancrée sur l'Atlantique.", image: "/artworks/geo_2.jpg" },
      { id: "an3", title: "Madrid", subject: "Géographie", text: "L'élégance castillane, le soleil et la passion.", image: "/artworks/geo_3.jpg" },
      { id: "an4", title: "Las Vegas", subject: "Géographie", text: "Le mirage du désert, l'oasis de lumière et de démesure.", image: "/artworks/geo_4.jpg" },
      { id: "an5", title: "Tokyo", subject: "Géographie", text: "La mégalopole infinie, l'alliance de la tradition et du futur.", image: "/artworks/geo_5.jpg" },
      { id: "an5_1", title: "Lille", subject: "Géographie", text: "Le 59. La chaleur du Nord, l'architecture flamande en typographie.", image: "/artworks/ville_6.jpg" },
      { id: "an5_2", title: "Béziers", subject: "Géographie", text: "L'accent du Sud, l'arène et le soleil d'Occitanie.", image: "/artworks/ville_7.jpg" },
      { id: "an5_3", title: "Lyon", subject: "Géographie", text: "Le 69. La capitale des Gaules forgée par ses deux fleuves.", image: "/artworks/ville_8.jpg" },
      { id: "an5_4", title: "Marseille", subject: "Géographie", text: "Le 13. La cité phocéenne, rebelle, vibrante et méditerranéenne.", image: "/artworks/ville_9.jpg" },
      { id: "an5_5", title: "Rennes", subject: "Géographie", text: "Le 35. Le cœur vibrant de la Bretagne, historique et festif.", image: "/artworks/ville_10.jpg" },
      ...
      { id: "an35", title: "Nouvelle-Aquitaine", subject: "Région HV", text: "Le code postal 33000 tissé au cœur du grand Sud-Ouest.", image: "/artworks/region_12.jpg" },
      ...
      { id: "an14", title: "Italia", subject: "Pays", text: "L'art antique, la dolce vita, la péninsule au centre de l'histoire.", image: "/artworks/italia_map.jpg" },
      ...
      { id: "an23", title: "Venise", subject: "Monument", text: "La Sérénissime, les gondoles et l'éternité flottant sur les eaux.", image: "/artworks/monument_8.jpg" },
  ...
  },
  {
    ...
    artworks: [
      ...
      { id: "ar11", title: "Le Pur Sang", subject: "Emblème", text: "L'élégance animale, la puissance et la noblesse brute.", image: "/artworks/embleme_5.jpg" },
      ...
      { id: "ar16", title: "Les 3 Bandes (Athlètes)", subject: "Adidas", text: "Messi, Mahomes, Serena... Les icÃ´nes qui forgent l'histoire du sport.", image: "/artworks/adidas_2.jpg", hc: true },
  ...
  },
  {
    ...
    artworks: [
      ...
      { id: "ar11", title: "NX Champions 25", subject: "Club", text: "Champion 2025. La capitale s'impose sur les parquets.", image: "/artworks/paris_basket_1.jpg" },
      { id: "ar12", title: "NX PB Triomphe", subject: "Club", text: "L'identité visuelle du club de la Ville Lumière.", image: "/artworks/paris_basket_2.jpg" },
      ...
      { id: "ar21_1", title: "Fly Emirates F1", subject: "Course Automobile", text: "L'aérodynamisme taillé dans le texte, l'alliance de la vitesse et de la puissance.", image: "/artworks/emirates_f1.jpg" },
      { id: "ar22", title: "La Puissance Pure", subject: "Cyclisme", text: "La puissance pure. L'arc-en-ciel sur les routes, la domination d'un champion hors norme.", image: "/artworks/sport_8.jpg" },
  ...
  },
  {
    ...
    artworks: [
      ...
      { id: "fo3", title: "Nadir Hifi", subject: "Paris Basket X Inclusion", text: "La silhouette typographique. Ensemble, l'égalité des chances.", image: "/artworks/inclusion_3.jpg" },
  ...
  },
  {
    ...
    artworks: [
      { id: "nxr1", title: "Charente-Maritime", subject: "Stade Rochelais", text: "Le 17. Le département dessiné par les noms de ses fiers corsaires.", image: "/artworks/hands_echo_1.jpg" },
      { id: "nxr2", title: "La Caravelle", subject: "Stade Rochelais", text: "Le logo historique sculpté par l'effectif maritime champion d'Europe.", image: "/artworks/hands_echo_2.jpg" },
      { id: "nxr3", title: "Charente-Maritime (Or)", subject: "Stade Rochelais", text: "Le 17. Le département dessiné par les noms de ses fiers corsaires sur fond or.", image: "/artworks/rochelais_map_1.jpg" },
      { id: "nxr4", title: "La Caravelle (Or)", subject: "Stade Rochelais", text: "Le logo historique sculpté par l'effectif maritime champion d'Europe sur fond or.", image: "/artworks/rochelais_caravelle_1.jpg" },
