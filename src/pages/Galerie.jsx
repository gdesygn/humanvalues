...
const ailes = [
  ...
  },
  {
    ...
    artworks: [
      ...
      { id: "val8", title: "L'Altruisme", subject: "Vertu Sportive", text: "Le meneur de jeu. La valeur suprême qui fait briller les autres.", image: "/artworks/valeur_8.jpg" },
      ...
      { id: "val12", title: "La Sagesse", subject: "Vertu Sportive", text: "Les gants suspendus. L'apprentissage par l'effort et la douleur.", image: "/artworks/valeur_12.jpg" },
  ...
  },
  {
    ...
    artworks: [
      ...
      { id: "mon14", title: "HV | L'Emblème", subject: "HumanValues", text: "Le flambeau de la liberté hissé par les mots. L'icône fondatrice de la collection artistique 2025.", image: "/artworks/flambeau_hv.jpg" },
  ...
  },
  {
    ...
    artworks: [
      ...
      { id: "are_inst_2", title: "Volley-Ball", subject: "FFVolley", text: "L'envol, le smash, l'excellence de la Fédération Française de Volley.", image: "/artworks/ffvolley_rooster.jpg", hc: true },
      ...
      { id: "ar10", title: "NX TP vs TP", subject: "Basket", text: "La conclusion, le buzzer beater, la victoire collective.", image: "/artworks/ffbb_10.jpg", hc: true },
      ...
      { id: "ar21_1", title: "Formula One", subject: "Course Automobile", text: "L'aérodynamisme taillé dans le texte, l'alliance de la vitesse et de la puissance.", image: "/artworks/emirates_f1.jpg", hc: true },
    ...
    <div className="container" style={{ maxWidth: '1400px', margin: '0 auto', paddingBottom: '10vh' }}>
      <header style={{ marginBottom: '6rem', textAlign: 'center' }}>
        ...
        <p style={{ fontStyle: 'italic', fontSize: '1.2rem', color: 'var(--hv-grey)', marginBottom: '1.5rem' }}>
          Entrez dans le Registre. Parcourez nos collections et découvrez nos œuvres.
        </p>
      ...
      <div style={{ textAlign: 'center', marginTop: '12rem', borderTop: '1px solid var(--hv-light-grey)', paddingTop: '6rem' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '1rem', marginBottom: '4rem' }}>
          ...
          <div style={{ 
            ...
            <strong>⭐ Solidarité & Mécénat :</strong> Pour toute acquisition d'une œuvre signalée par une étoile jaune, <strong>20% des revenus</strong> sont reversés à notre partenaire caritatif (JC Skarbowsky Gym).
          </div>
        </div>
